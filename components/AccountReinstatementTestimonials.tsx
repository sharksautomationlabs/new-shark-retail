...
const AccountReinstatementTestimonials: React.FC = () => {
  ...
  const testimonials = [
    { name: "Sarah Chen", role: "E-Commerce Portfolio Manager", company: "Digital Ventures Capital", date: "Jan 15, 2025", content: "Retail Automation's account reinstatement services delivered exceptional results. Within 7 days, they recovered our suspended Amazon account that had been down for 2 months. Their systematic approach to compliance management and documentation transformed our suspended assets into fully operational accounts.", metrics: [{ label: "Recovery Time", value: "7 Days" }, { label: "Success Rate", value: "95%" }] },
    { name: "Marcus Rodriguez", role: "Investment Director", company: "Retail Innovation Fund", date: "Dec 12, 2024", content: "The institutional-grade account recovery frameworks deployed by Retail Automation exceeded all expectations. Our multi-platform account reinstatement achieved 98% success rate across Amazon, eBay, and Shopify. Their proprietary compliance systems consistently deliver superior results.", metrics: [{ label: "Platforms Recovered", value: "3" }, { label: "Compliance Rate", value: "98%" }] },
    { name: "Jennifer Walsh", role: "Capital Allocation Director", company: "E-Commerce Growth Partners", date: "Nov 25, 2024", content: "Working with Retail Automation's account reinstatement team transformed our suspended business operations into a systematic, compliant platform. Their emergency recovery protocols and documentation systems delivered 100% business continuity within 5 days. The institutional-grade reporting and compliance insights are unmatched.", metrics: [{ label: "Business Continuity", value: "100%" }, { label: "Emergency Response", value: "5 Days" }] },
  ];
    ...
    <section className="relative bg-[#020205] py-24 sm:py-32 px-4 sm:px-6 lg:px-12 overflow-hidden font-sans selection:bg-teal-500/30 selection:text-white">
      ...
      <div className="container mx-auto relative z-10">
        <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-16">
          ...
          <p className="text-gray-400 text-lg max-w-3xl mx-auto font-medium">Our partners have achieved extraordinary account recovery success through systematic reinstatement. Scale smarter, sell faster.</p>
