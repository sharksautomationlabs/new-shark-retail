...
const AccountReinstatementTestimonials: React.FC = () => {
  ...
  const testimonials = [
    { name: "Sarah Chen", role: "E-Commerce Portfolio Manager", company: "Digital Ventures Capital", date: "Jan 15, 2025", content: "Shark Retail's account reinstatement services delivered exceptional results. Within 7 days, they recovered our suspended Amazon account that had been down for 2 months. Their systematic approach to compliance management and documentation transformed our suspended assets into fully operational accounts.", metrics: [{ label: "Recovery Time", value: "7 Days" }, { label: "Success Rate", value: "95%" }] },
    { name: "Marcus Rodriguez", role: "Investment Director", company: "Retail Innovation Fund", date: "Dec 12, 2024", content: "The institutional-grade account recovery frameworks deployed by Shark Retail exceeded all expectations. Our multi-platform account reinstatement achieved 98% success rate across Amazon, eBay, and Shopify. Their proprietary compliance systems consistently deliver superior results.", metrics: [{ label: "Platforms Recovered", value: "3" }, { label: "Compliance Rate", value: "98%" }] },
