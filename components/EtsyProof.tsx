    ...
    >
      ...
      <div className="container mx-auto max-w-6xl relative z-10">
        ...
        >
          <motion.div
            variants={fadeUp}
            className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/[0.03] border border-white/[0.05] backdrop-blur-md mb-6 shadow-2xl"
          >
          ...
          >
            Comprehensive analytics showcasing how our Etsy automation drives
            consistent orders, repeat customers, and scalable revenue for your
            handmade and vintage brand.
          </motion.p>
        ...
        <LayoutGroup>
              ...
              <div className="relative px-6 pt-8 pb-6 sm:px-10 sm:pt-10 sm:pb-8">
                ...
                <div className="relative aspect-[16/9] rounded-2xl overflow-hidden bg-black/60 border border-white/10">
                  <motion.img
                    ...
                    layoutId={`etsy-proof-${activeIndex}`}
          ...
          <motion.div
            ...
            initial="hidden"
            animate={isInView ? "visible" : "hidden"}
            className="flex gap-4 sm:gap-6 overflow-x-auto pb-3 mb-6"
          >
              ...
              <motion.div
                ...
                className={`min-w-[180px] sm:min-w-[220px] rounded-2xl overflow-hidden cursor-pointer transition-all duration-300 ${
                  activeIndex === index
                    ...
                    : "bg-[#050609]/90 border border-white/10 hover:border-teal-400/60"
                }`}
              >
                <div className="relative aspect-[4/3] overflow-hidden">
                  <motion.img
                    src={proof.image}
                    alt={proof.alt}
                    layoutId={`etsy-proof-${index}`}
                    className="w-full h-full object-cover opacity-90"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent" />
                </div>
                <div className="px-4 py-3 text-xs text-slate-300 truncate">
                  {proof.alt}
                </div>
              </motion.div>
            ))}
          ...
          <div className="relative bg-[#0a0a0c] rounded-[2.4rem] p-8 sm:p-12 flex flex-col sm:flex-row items-center justify-between gap-8">
            <div>
              <h3 className="text-2xl sm:text-3xl font-bold text-white mb-3 tracking-tight">
                Ready to See These Results for Your Etsy Shop?
              </h3>
              <p className="text-gray-400 font-medium">
                Join our approach to Etsy automation and start generating
                consistent, measurable returns from your creative brand.
              </p>
            </div>
            <a
              href="/contact"
