...
const ProductHuntingTestimonials: React.FC = () => {
  ...
  const testimonials = [
    { name: "Alex Thompson", role: "E-commerce Director", company: "Digital Ventures Group", date: "Jan 18, 2025", content: "Shark Retail's product research methodology transformed our entire e-commerce strategy. Their data-driven approach identified winning products that increased our revenue by 400% in just 6 months. The systematic market analysis and trend identification frameworks are truly exceptional.", metrics: [{ label: "Revenue Growth", value: "400%" }, { label: "Time to Results", value: "6 Months" }] },
    { name: "Maria Rodriguez", role: "Product Manager", company: "Global Retail Solutions", date: "Dec 15, 2024", content: "The product hunting insights provided by Shark Retail revolutionized our entire product portfolio. Their comprehensive analysis of market trends and competitor strategies helped us launch 25+ successful products. The ROI on their research achieved 100% growth within six months.", metrics: [{ label: "Products Launched", value: "25+" }, { label: "ROI Growth", value: "100%" }] },
    { name: "James Chen", role: "E-commerce Operations Lead", company: "Marketplace Masters", date: "Nov 28, 2024", content: "Working with Shark Retail's product research team was a game-changer for our marketplace operations. Their supplier sourcing and market validation strategies increased our profit margins by 180% and reduced our product failure rate by 70%. The systematic approach delivers measurable results.", metrics: [{ label: "Profit Margins", value: "180%" }, { label: "Failure Rate Reduction", value: "70%" }] },
  ];
