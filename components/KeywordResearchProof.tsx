...
const targetCounts = { years: 8, clients: 450, keywords: 20000, rankings: 5000 };
const statLabels: Record<string, string> = { years: "Years of Experience", clients: "Active Clients", keywords: "Keywords Researched", rankings: "Top Rankings" };
const statSuffixes: Record<string, string> = { years: "+", clients: "+", keywords: "+", rankings: "+" };

const KeywordResearchProof: React.FC = () => {
  const [counts, setCounts] = useState({ years: 0, clients: 0, keywords: 0, rankings: 0 });
      ...
      <div className="container mx-auto max-w-6xl relative z-10">
        <motion.div variants={staggerContainer} initial="hidden" animate={isInView ? "visible" : "hidden"} className="text-center mb-16">
          ...
          <motion.h2 variants={fadeUp} className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-white tracking-tight mb-4">
            Building Organic Authority, <span className="text-transparent bg-clip-text bg-gradient-to-r from-teal-300 via-teal-400 to-emerald-300">One Keyword at a Time</span>
          </motion.h2>
