...
const proofData = [
  { image: '/images/shopify-proof/sopify-sale1.png', alt: 'Shopify Performance 1' },
  { image: '/images/shopify-proof/shopify-sale2.png', alt: 'Shopify Performance 2' },
  { image: '/images/shopify-proof/shopify-sale3.png', alt: 'Shopify Performance 3' },
];
      ...
      <div className="container mx-auto max-w-6xl relative z-10">
        ...
        >
          ...
          <motion.p variants={fadeUp} className="text-gray-400 text-lg max-w-3xl mx-auto font-medium">
            Comprehensive analytics showcasing how our Shopify automation drives conversion, scales revenue, and keeps your store operating flawlessly.
          </motion.p>
            ...
            >
              ...
              <div className="relative px-6 pt-8 pb-6 sm:px-10 sm:pt-10 sm:pb-8">
                <div className="mb-6 flex items-center justify-between text-xs font-mono text-teal-200/80 uppercase tracking-[0.25em]">
                  <span>Shopify • Live Console</span>
                ...
                <div className="relative aspect-[16/9] rounded-2xl overflow-hidden bg-black/60 border border-white/10">
                  <motion.img
                    ...
                    layoutId={`shopify-proof-${activeIndex}`}
                ...
                <div className="mt-6 grid grid-cols-1 sm:grid-cols-3 gap-4 text-left text-xs sm:text-sm font-medium text-teal-100/90">
                  <div className="rounded-xl bg-white/5 border border-white/10 px-4 py-3">
                    ...
                    <div className="text-xl font-bold text-teal-300">+180%</div>
                    <div className="text-[0.75rem] text-slate-400">Client store lift</div>
                  </div>
                  <div className="rounded-xl bg-white/5 border border-white/10 px-4 py-3">
                    <div className="text-[0.65rem] uppercase tracking-[0.25em] text-slate-400 mb-1">Monthly Revenue</div>
                    <div className="text-xl font-bold text-teal-300">$75K+</div>
                    <div className="text-[0.75rem] text-slate-400">Scaled stores</div>
                  </div>
                  <div className="rounded-xl bg-white/5 border border-white/10 px-4 py-3">
                    <div className="text-[0.65rem] uppercase tracking-[0.25em] text-slate-400 mb-1">Profit Margins</div>
                    <div className="text-xl font-bold text-teal-300">+150%</div>
                    <div className="text-[0.75rem] text-slate-400">Improved margins</div>
                  </div>
                </div>
              </div>
            </motion.div>
          ...
          <div className="relative bg-[#0a0a0c] rounded-[2.4rem] p-8 sm:p-12 flex flex-col sm:flex-row items-center justify-between gap-8">
            <div>
              ...
              <p className="text-gray-400 font-medium">
                Join our approach to Shopify automation and start generating consistent, measurable returns.
              </p>
            </div>
            <a
              href="/contact"
