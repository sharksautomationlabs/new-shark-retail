...
const EtsyCTA: React.FC = () => {
  ...
  const countryCodes = [
    ...
    // ... (you can keep your full list here as needed)
    ...
    <section className="relative bg-[#020202] py-24 sm:py-32 px-4 sm:px-8 lg:px-12 overflow-hidden font-sans selection:bg-teal-500/30 selection:text-white">
      ...
      <div className="container mx-auto max-w-6xl relative z-10">
        ...
        >
          ...
          >
            Ready to elevate your Etsy shop? Share a few details and our team
            will design a premium automation roadmap tailored to your products
            and goals.
          </motion.p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 sm:gap-16 items-start">
          ...
          >
            ...
            <div className="relative bg-[#0a0a0c]/90 backdrop-blur-2xl border border-white/10 p-6 sm:p-8 rounded-[2rem]">
              ...
              <p className="text-sm text-gray-400 mb-6 sm:mb-8">
                We&apos;ll review your products, niche, and goals—then come back
                with a clear automation strategy to grow your Etsy revenue.
              </p>
              ...
              <form onSubmit={handleSubmit} className="space-y-5 sm:space-y-6">
                ...
                <FormField
                  label="Tell us about your Etsy goals"
                  as="textarea"
                  name="projectDetails"
          ...
          >
            {[
              {
                icon: TrendingUp,
                title: "Premium Etsy Automation",
                desc: "From shop setup and branding to inventory, pricing, and fulfillment systems.",
              },
              {
                icon: Mail,
                title: "Email",
