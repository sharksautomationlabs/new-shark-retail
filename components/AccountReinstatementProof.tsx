...
const targetCounts = { accounts: 2500, success: 95, platforms: 8, satisfaction: 99 };
const statLabels: Record<string, string> = { accounts: "Accounts Recovered", success: "Success Rate", platforms: "Platforms Supported", satisfaction: "Client Satisfaction" };
const statSuffixes: Record<string, string> = { accounts: "+", success: "%", platforms: "+", satisfaction: "%" };
      ...
      <div className="container mx-auto max-w-6xl relative z-10">
        <motion.div variants={staggerContainer} initial="hidden" animate={isInView ? "visible" : "hidden"} className="text-center mb-16">
          ...
          <motion.h2 variants={fadeUp} className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-white tracking-tight mb-4">
            Building The Recovery of <span className="text-transparent bg-clip-text bg-gradient-to-r from-teal-300 via-teal-400 to-emerald-300">Tomorrow, Today</span>
          </motion.h2>
          <motion.p variants={fadeUp} className="text-gray-400 text-lg max-w-3xl mx-auto font-medium">
            We help businesses recover their suspended accounts with measurable results.
          </motion.p>
        </motion.div>
