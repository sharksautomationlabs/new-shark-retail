...
const ContentCreationTestimonials: React.FC = () => {
  ...
  const testimonials = [
    { name: "Sarah Chen", role: "Creative Director", company: "Digital Ventures Capital", date: "Jan 15, 2025", content: "Shark Retail's content creation services revolutionized our brand presence. Within 30 days, we achieved 400% engagement increase while reducing content production costs by 70%. Their systematic approach to creative strategy and visual content transformed our brand into a market-leading presence.", metrics: [{ label: "Engagement Growth", value: "400%" }, { label: "Cost Reduction", value: "70%" }] },
    { name: "Marcus Rodriguez", role: "Marketing Director", company: "Retail Innovation Fund", date: "Dec 12, 2024", content: "The institutional-grade content creation frameworks deployed by Shark Retail exceeded all expectations. Our brand consistency improved by 95% while content production speed increased by 300%. Their proprietary creative systems consistently deliver superior brand messaging across all platforms.", metrics: [{ label: "Brand Consistency", value: "95%" }, { label: "Production Speed", value: "300%" }] },
    { name: "Jennifer Walsh", role: "Brand Manager", company: "E-Commerce Growth Partners", date: "Nov 25, 2024", content: "Working with Shark Retail's content creation team transformed our brand presence into a systematic, scalable platform. Their visual content mastery and copywriting systems delivered 250% brand recognition growth within three months. The institutional-grade creative insights and production automation are unmatched.", metrics: [{ label: "Brand Recognition", value: "250%" }, { label: "Timeframe", value: "3 Months" }] },
  ];
