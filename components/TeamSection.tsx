...
const teamData = [
  {
    name: "Aain Ali",
    company: "Retail Automation",
    companyColor: "text-teal-400",
    titles: ["Sr. Ecommerce Consultant"],
    imageUrl: "/images/team/3.png",
    logoUrl: "/images/retail-automation-logo.png",
    ...
    instagramUrl: "https://www.instagram.com/iamaainali?utm_source=qr&igsh=MTNjOGU4OXUwM3BwdQ==",
  },
  {
    name: "Zayaan",
    company: "Retail Automation",
    ...
    instagramUrl: "https://www.instagram.com/muhammadzayaanofficial/",
    facebookUrl: "https://www.facebook.com/people/Ecommerce-Sharks/61584113035162/",
  },
];
    ...
    >
      ...
      <div className="absolute top-6 left-6 z-20">
        <div className="px-4 py-2 bg-black/20 backdrop-blur-md border border-white/10 rounded-full flex items-center justify-center transform -translate-y-4 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500 delay-100">
          <Image
            src={member.logoUrl}
            alt="The Retail Automation"
            width={180}
            height={44}
            className="h-10 w-auto max-w-[180px] sm:h-11 sm:max-w-[200px] object-contain"
          />
        </div>
      </div>
      ...
      <div className="absolute bottom-0 left-0 w-full p-8 sm:p-10 z-20 flex justify-between items-end transform translate-y-4 group-hover:translate-y-0 transition-transform duration-500 ease-out">
        ...
        <div className="flex items-center gap-2 transform scale-0 group-hover:scale-100 transition-transform duration-500 delay-200">
          {member.instagramUrl && (
            <a
              href={member.instagramUrl}
              target="_blank"
              rel="noopener noreferrer"
              className="w-12 h-12 rounded-full bg-teal-400 flex items-center justify-center hover:bg-white shadow-[0_0_20px_rgba(45,212,191,0.5)] transition-colors"
      ...
      <div className="container mx-auto max-w-6xl relative z-10">
        ...
        >
          ...
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/[0.03] border border-white/[0.05] mb-6">
            ...
            <span className="text-xs font-semibold text-gray-400 uppercase tracking-[0.2em]">Your specialist bench</span>
          </div>

          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold text-white tracking-tight leading-tight">
            Operators behind <br className="hidden sm:block" />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-teal-400 to-emerald-300">
              every live automation program
            </span>
          </h2>
