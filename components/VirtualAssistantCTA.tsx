...
import { ChevronDown, Phone, Headphones, Mail, MapPin } from 'lucide-react';
      ...
      <div className="container mx-auto max-w-6xl relative z-10">
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-teal-500/30 bg-teal-500/10 backdrop-blur-md shadow-[0_0_20px_rgba(20,184,166,0.15)] mb-6">
            ...
            <span className="text-[10px] font-bold text-teal-400 uppercase tracking-[0.3em]">Virtual Assistant</span>
          </div>
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold text-white tracking-tight mb-4 leading-[1.1]">
            Let&apos;s Talk About Your <span className="text-transparent bg-clip-text bg-gradient-to-r from-teal-300 via-teal-400 to-emerald-300">Virtual Assistant</span> Needs
          </h2>
          <p className="text-lg text-gray-400 max-w-2xl mx-auto font-medium mb-12">
            Ready to streamline operations? Share a few details and our team will design a tailored virtual assistance solution for your business.
          </p>
        </div>
        ...
        <div className="relative">
          ...
          <h3 className="text-2xl font-bold text-white mb-2">Premium Virtual Assistance For Your Business</h3>
          <p className="text-sm text-gray-400 mb-6 sm:mb-8">
            Tell us about your operations and we&apos;ll design a tailored virtual assistance solution for your needs.
          </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-5 sm:space-y-6">
            ...
            <FormField 
              label="Tell us about your virtual assistant needs" 
              as="textarea" 
              name="projectDetails"
        ...
        <div className="space-y-6">
          {[
            { icon: Headphones, title: "Scale Your Operations", desc: "Customer service, admin support, order processing, and data management—solutions that help you operate smarter and scale faster." },
