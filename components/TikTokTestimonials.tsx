...
const TikTokTestimonials: React.FC = () => {
  ...
  const testimonials = [
    { name: 'Alex Chen', role: 'TikTok Content Creator', date: 'Jan 10, 2025', content: 'ECOM SHARKS TikTok automation services are game-changing! They helped us grow from 1K to 500K followers in just 6 months. Their content strategy and posting automation increased our engagement by 300%. Our brand visibility skyrocketed!', metrics: [{ label: 'Followers', value: '500K' }, { label: 'Engagement', value: '+300%' }] },
    { name: 'Sophie Anderson', role: 'Social Media Manager', date: 'Dec 22, 2024', content: 'The TikTok automation from ECOM SHARKS transformed our social media presence. They automated our content creation, posting schedule, and audience engagement. Our reach increased by 400% and we\'re now generating consistent leads for our business!', metrics: [{ label: 'Reach Lift', value: '+400%' }, { label: 'Leads', value: 'Consistent' }] },
    { name: 'Ryan Patel', role: 'Digital Marketing Specialist', date: 'Nov 15, 2024', content: 'Working with ECOM SHARKS for TikTok automation has been incredible. They set up advanced targeting, automated our ad campaigns, and optimized our content for maximum viral potential. Our conversion rate improved by 250% and we\'re dominating our niche!', metrics: [{ label: 'Conversion', value: '+250%' }, { label: 'Niche', value: 'Dominating' }] },
  ];
