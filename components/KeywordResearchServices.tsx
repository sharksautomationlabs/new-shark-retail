...
const services = [
  { title: "Comprehensive Market Analysis", desc: "Deep analysis of your market, competitors, and search landscape. Competitor keyword mapping, SERP feature breakdown, seasonality patterns, and opportunity scoring.", icon: Search },
  { title: "Long-tail Keyword Discovery", desc: "Find low-competition, high-conversion intent keywords your competitors miss. Query expansion, topic clustering, intent qualification, and content brief generation.", icon: Target },
  { title: "Competitor Intelligence Report", desc: "Reverse-engineered keyword strategies from top competitors. Share of voice analysis, content gap identification, backlink-powered targets, and SERP layout impact.", icon: Users },
  { title: "Keyword Strategy & Implementation", desc: "Full funnel keyword strategy with content mapping and release sequencing. Cluster-to-URL mapping, topical authority plan, on-page optimization, and measurement framework.", icon: Rocket },
];
      ...
      <div className="container mx-auto max-w-6xl relative z-10">
        <motion.div variants={staggerContainer} initial="hidden" animate={isInView ? "visible" : "hidden"} className="text-center mb-16">
          ...
          <motion.h2 variants={fadeUp} className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-white tracking-tight mb-4">
            Keyword Research <span className="text-transparent bg-clip-text bg-gradient-to-r from-teal-300 via-teal-400 to-emerald-300">Solutions</span>
          </motion.h2>
