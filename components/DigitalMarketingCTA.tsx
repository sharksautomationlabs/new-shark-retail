...
// --- Digital Marketing CTA Component ---
const DigitalMarketingCTA: React.FC = () => {
    ...
    <section className="relative bg-[#020202] py-24 sm:py-32 px-4 sm:px-8 lg:px-12 overflow-hidden font-sans selection:bg-teal-500/30 selection:text-white">
      ...
      <div className="container mx-auto max-w-6xl relative z-10">
        ...
        >
          ...
          >
            Ready to scale your brand? Share a few details and our team
            will design a premium digital marketing strategy tailored to your goals.
          </motion.p>
        </motion.div>
          ...
          >
            ...
            <div className="relative bg-[#0a0a0c]/90 backdrop-blur-2xl border border-white/10 p-6 sm:p-8 rounded-[2rem]">
              <h3 className="text-2xl font-bold text-white mb-2">
                Premium Digital Marketing Strategy For Your Brand
              </h3>
              <p className="text-sm text-gray-400 mb-6 sm:mb-8">
                Tell us about your brand and we&apos;ll design a data-driven
                digital marketing strategy tailored to your goals.
              </p>
              ...
              <form onSubmit={handleSubmit} className="space-y-5 sm:space-y-6">
                ...
                <FormField
                  label="Tell us about your digital marketing goals"
                  as="textarea"
                  name="projectDetails"
            ...
            {[
              {
                ...
                desc: "PPC, SEO, social media, content marketing, and analytics—strategies that help you sell faster and scale smarter.",
              },
              {
                icon: Mail,
                title: "Email",
