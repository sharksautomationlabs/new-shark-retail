...
import { ArrowRight, TrendingUp, BarChart3, Target, Search } from "lucide-react";
...
const services = [
  {
    ...
    desc: "Full lifecycle management of Sponsored Products campaigns—keyword research, bid optimization, negative keyword strategy, and search term mining.",
    icon: TrendingUp,
  },
  {
    title: "Sponsored Brands & Display",
    desc: "Brand awareness and retargeting campaigns with optimized creative, landing pages, and audience targeting for higher-margin conversions.",
    icon: BarChart3,
  },
  {
    title: "ACOS & ROAS Optimization",
    desc: "Data-driven bid strategies, budget allocation, and performance reporting to reduce Advertising Cost of Sale and maximize Return on Ad Spend.",
    icon: Target,
  },
  {
    title: "Keyword & Search Term Mining",
    desc: "Deep keyword research, competitor analysis, and search term harvesting to uncover high-intent opportunities and cut wasteful spend.",
    icon: Search,
  },
];

const AmazonPPCServices: React.FC = () => {
      ...
      <div className="container mx-auto max-w-6xl relative z-10">
        ...
        >
          ...
          <motion.h2 variants={fadeUp} className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-white tracking-tight mb-4">
            Amazon PPC <span className="text-transparent bg-clip-text bg-gradient-to-r from-teal-300 via-teal-400 to-emerald-300">Services</span>
          </motion.h2>
          <motion.p variants={fadeUp} className="text-gray-400 text-lg max-w-3xl mx-auto font-medium">
            End-to-end Amazon PPC management designed to lower ACOS, boost ROAS, and scale your advertising profitably.
          </motion.p>
        </motion.div>
