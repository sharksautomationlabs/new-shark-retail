...
const cards = [
  {
    ...
    desc: "Strategic keyword and negative keyword targeting to maximize visibility and reduce wasted spend on Amazon Sponsored Products.",
    icon: (
      <svg
        className="w-7 h-7"
        fill="none"
  ...
  },
  {
    ...
    desc: "Brand-focused campaigns and display retargeting to increase brand awareness and drive higher-margin conversions.",
    icon: (
      <svg
        className="w-7 h-7"
        fill="none"
  ...
  {
    label: "APPC—03",
    title: "Keyword & Campaign Analysis",
    desc: "Data-driven bid optimization, search term mining, and performance reporting to consistently improve ACOS and ROAS.",
    icon: (
      <svg
        className="w-7 h-7"
        fill="none"
  ...
  },
  {
    ...
    desc: "Scalable PPC strategies that grow with your catalog—from launch to category dominance with measurable ROI.",
    icon: (
      <svg
        className="w-7 h-7"
        fill="none"
...
const AmazonPPCMainContent: React.FC = () => {
      ...
      <div className="container mx-auto max-w-7xl relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-20 items-center">
          ...
          >
            ...
            >
              Our Amazon PPC experts deploy data-driven strategies across
              Sponsored Products, Sponsored Brands, and Sponsored Display. We cut
              ACOS, boost ROAS, and scale your advertising spend profitably.
            </motion.p>
            <motion.p
              variants={fadeUp}
...
export default AmazonPPCMainContent;
