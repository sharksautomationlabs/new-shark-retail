...
const servicesData = [
  ...
  },
  {
    ...
    description:
      'Improve efficiency and attain massive profitability by automating order fulfillment processes and make leaps in the competitive world.',
    icon: <OrderIcon />,
  },
];
            ...
            <motion.div key={service.number} variants={fadeUp} className="relative group h-full">
              ...
              <div className="relative h-full rounded-2xl border border-white/[0.06] bg-[#0a0a0c]/90 backdrop-blur-xl p-8 sm:p-10 shadow-2xl shadow-black/40 group-hover:border-teal-500/20 group-hover:shadow-[0_0_60px_rgba(20,184,166,0.1)] transition-all duration-500">
                <div className="flex items-center gap-4 mb-6">
                  <div className="flex items-center justify-center w-14 h-14 rounded-xl bg-teal-500/15 text-teal-400 border border-teal-500/20 group-hover:bg-teal-500/25 transition-colors">
                    {service.icon}
                  </div>
                ...
                <a
                  href="/contact"
                  className="inline-flex items-center gap-2 text-teal-400 font-bold text-sm uppercase tracking-wider hover:text-teal-300 transition-colors group/link"
                >
                  Get A Quote
