...
const advantages = [
  { title: "Scalable Growth", description: "Marketing strategies that scale with your catalog—from launch to market leadership." },
  { title: "Expert Support", description: "Dedicated team that delivers custom campaigns and real-time performance analytics." },
  { title: "Market Leadership", description: "Data-driven strategies that outperform competitors and drive sustained growth." },
  { title: "Transparent Results", description: "Clear dashboards and reports so you always know where your marketing spend goes." },
];

const challenges = [
  { title: "DIY Complexity", description: "Managing PPC, SEO, and social media alone leads to wasted spend and missed opportunities." },
  { title: "Competitive Landscape", description: "High CPCs and fierce competition make it hard to achieve ROI without expertise." },
  { title: "Scattered Efforts", description: "Without a unified strategy, campaigns conflict and budgets get diluted." },
  { title: "Scaling Blind", description: "Scaling without data-driven optimization often increases spend without profit growth." },
];

const DigitalMarketingEdge: React.FC = () => {
...
export default DigitalMarketingEdge;
