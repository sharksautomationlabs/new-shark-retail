...
const cards = [
  {
    ...
    desc: "Precision campaigns across Google, Meta, Amazon, and TikTok. Maximize ROAS and scale profitable ad spend.",
    icon: (
      <svg
        className="w-7 h-7"
        fill="none"
  ...
  },
  {
    ...
    desc: "Keyword research, on-page optimization, and content strategy to rank higher and drive organic traffic.",
    icon: (
      <svg
        className="w-7 h-7"
        fill="none"
  ...
  },
  {
    ...
    desc: "Brand awareness and engagement across Instagram, Facebook, TikTok, and Pinterest for e-commerce brands.",
    icon: (
      <svg
        className="w-7 h-7"
        fill="none"
  ...
  },
  {
    ...
    desc: "Data-driven insights, performance dashboards, and conversion tracking to optimize every channel.",
    icon: (
      <svg
        className="w-7 h-7"
        fill="none"
...
const DigitalMarketingMainContent: React.FC = () => {
      ...
      <div className="container mx-auto max-w-7xl relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-20 items-center">
          ...
          >
            <motion.div
              variants={fadeUp}
              className="inline-flex items-center gap-2 rounded-full border border-teal-500/20 bg-teal-500/5 px-4 py-1.5 text-xs font-bold uppercase tracking-[0.25em] text-teal-400 backdrop-blur-md"
            >
            ...
            >
              Retail Automation delivers comprehensive marketing strategies—PPC, SEO,
              social media, content marketing, and analytics. We help e-commerce
              brands scale smarter and sell faster.
            </motion.p>
            <motion.p
              variants={fadeUp}
              className="text-slate-400 text-base md:text-lg leading-relaxed font-light"
            >
              From basic marketing and advertising support to custom campaigns
              and real-time performance analytics—we tailor strategies for your
              goals. Partner with Retail Automation for digital marketing built for
              long-term growth.
            </motion.p>
            ...
            {[cards[0], cards[1]].map((card, i) => (
              ...
              >
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <span className="text-xs font-bold text-teal-400/90 uppercase tracking-widest">
                    {card.label}
                  </span>
                </div>
...
export default DigitalMarketingMainContent;
