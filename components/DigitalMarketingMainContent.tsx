      ...
      <div className="container mx-auto max-w-7xl relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-20 items-center">
          ...
          >
            ...
            >
              Shark Retail delivers comprehensive marketing strategies—PPC, SEO,
            ...
            >
              ...
              goals. Partner with Shark Retail for digital marketing built for
              long-term growth.
            </motion.p>
